            ...
            <div class="panel-body">
                <div class="form">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-8">
                                <input class=" form-control" id="check_name" name="name" required/>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-8">
                                <input class=" form-control" id="check_phone" name="phone" required/>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-8">
                                <input class=" form-control" id="check_detail" name="detail" required/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-8">
                                ...
                                <input style="color: #0E993C" onclick="processing()" class="btn btn-warning notika-btn-warning" type="submit" value="ASSIGN"/>
